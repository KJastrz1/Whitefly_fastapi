...
async def get_sync_form(request: Request):
    return templates.TemplateResponse("form.html", {"request": request, "title": "Sync form"})
...
async def post_sync_form(request: Request, db: Session = Depends(get_db)):
    ...
    if not content:
        return templates.TemplateResponse("form.html", {"request": request, "error": "Content is required!", "content": content, "title": "Sync form"})
...
async def get_async_form(request: Request):
    return templates.TemplateResponse("form.html", {"request": request, "title": "Async form"})
...
async def post_async_form(request: Request):
    ...
    if not content:
        return templates.TemplateResponse("form.html", {"request": request, "error": "Content is required!", "content": content, "title": "Async form"})
